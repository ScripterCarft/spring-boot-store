...
import com.cirruslabs.store.mappers.ProductMapper;
import com.cirruslabs.store.repositories.CategoryRepository;
...
public class ProductController {
    ...
    public List<ProductDto> getAllProducts(@RequestParam(name = "categoryId", required = false) Byte categoryId) {
        ...
        return products
                ...
                .filter(dto -> categoryId == null || categoryId.equals(dto.getCategoryId()))
                .toList();
    }
